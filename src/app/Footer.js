  ...
  return (
    <footer className="footer-fixed">
      <div className="footer-row" style={{gap: 10, fontSize: '0.97em', padding: '0.2em 0'}}>
        <a className="footer-link" href="/impressum" target="_blank" rel="noopener noreferrer" style={{fontSize: '0.97em', padding: '0.18em 0.7em'}}>Impressum</a>
        ...
        <a className="footer-link" href="/datenschutz" target="_blank" rel="noopener noreferrer" style={{fontSize: '0.97em', padding: '0.18em 0.7em'}}>Datenschutz</a>
      </div>
    </footer>
  )
}
